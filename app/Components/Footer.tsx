        ...
        <footer className="p-4  mt-10  sm:p-6 ">
            <div className="mx-auto max-w-screen-xl">
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    ...
                    <span className="text-center text-sm text-gray-500"> Need a template for your portfolio? Clone this repo <a className="underline text-gray-600" href="https://github.com/chrisjnielson44/personal-portfolio-website" target="_blank" rel="noopener noreferrer">here</a>  </span>
