            ...
            <div className="container max-w-screen-xl mx-auto px-4 mt-20 ">
                ...
                <img src="home-image.jpg" className="grayscale rounded-2xl  md:mr-12 lg:h-23 w-auto " alt="Image" />
                    <div className="mr- ">
                        ...
                        <button className="px-7 py-3 md:px-9 md:py-4 bg-white w-full font-medium md:font-semibold text-gray-700 text-md rounded-md hover:bg-gray-700 hover:text-white transition ease-linear duration-500 shadow-xl">Get my CV</button>
                        </a>
                    </div>
                </div>
                {/* <div className='flex justify-center items-center'>
                    <a href="">
                    <svg className='h-10 w-10 stroke-black stroke-3' xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" clip-rule="evenodd"><path d="M23.245 4l-11.245 14.374-11.219-14.374-.781.619 12 15.381 12-15.391-.755-.609z"/></svg>
                    </a>
                </div> */}
...
<div className="container max-w-screen-xl mx-auto px-4">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 ">
        ...
        <div className="bg-gray-50 px-8 py-10 rounded-lg drop-shadow-xl">
            ...
            <img className="rounded-full grayscale shadow-lg" src="smallprof.png" alt="logo" height="70px" width="70px"></img>
            </a>
            <a href="https://cjnielson.com" target="_blank" rel="noopener noreferrer" className="">   
            ...
            <h3 className="font-medium text-gray-700 text-sm mb-5">
                    I've created a static personal portfolio website using Next.js. This site showcases my skills, projects, and achievements with a clean and user-friendly design. It is optimized for performance and provides a professional online presence to highlight my talents and accomplishments.</h3>
            <p className="text-gray-700 text-sm">
                <span className="bg-gray-200 text-gray-700 px-2 py-1  rounded-lg">
                    Next.js
                </span>
        ...
        <div className="bg-gray-50 px-8 py-10 rounded-lg drop-shadow-xl">
            <a href="https://github.com/chrisjnielson44/AI-Chatbot" target="_blank" rel="noopener noreferrer" className="">   
                <img className="rounded-full  shadow-lg border-2 p-2" src="chatgpt.png" alt="logo" height="70px" width="70px"></img>
            </a>  
            <a href="https://github.com/chrisjnielson44/AI-Chatbot" target="_blank" rel="noopener noreferrer" className="">           
