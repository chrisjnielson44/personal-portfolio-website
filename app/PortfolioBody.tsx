                    ...
                    <div className=" flex flex-col md:flex-row justify-left items-center md:items-start mb-5">
                        ...
                        <div className=" ">
                            ...
                            <a href="https://chris-n.s3.us-east-2.amazonaws.com/Christopher-Nielson-Resume.pdf" target="_blank" rel="noopener noreferrer">
                                <button className="animate-fade-up animate-ease-linear px-7 py-3 md:px-9 md:py-4 bg-white w-full font-medium md:font-semibold text-gray-700 text-md rounded-md hover:bg-gray-700 hover:text-white transition ease-linear duration-500 shadow-xl">Get my CV</button>
                            </a>
                        </div>
                    </div>
                ...
                <div className="container max-w-screen-xl mx-auto px-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 ">
                        ...
                        <div className="bg-gray-50 px-8 py-10 rounded-lg drop-shadow-xl">
                            ...
                            <h3 className="font-medium text-gray-700 text-sm mb-8">
                        ...
                        <div className="bg-gray-50 px-8 py-10 rounded-lg drop-shadow-xl">
                            ...
                            <h3 className="font-medium text-gray-700 text-sm mb-8">AI chatbot developed using Python and OpenAI&apos;s GPT-3.5 architecture. The chatbot is designed to remember conversations with the user and learn from them, allowing for more personalized and natural interactions.</h3>
                            <p className="text-gray-700 text-sm ">
                                <span className="bg-gray-200 text-gray-700 px-2 py-1 rounded-lg">
                                    Python
                                </span>
